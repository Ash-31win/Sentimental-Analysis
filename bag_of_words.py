...
df_positive.to_csv (r'C:\Users\HP\Desktop\sentimental analysis\df_bow_positive.csv', index = False, header=True)    
df_negative.to_csv (r'C:\Users\HP\Desktop\sentimental analysis\df_bow_negative.csv', index = False, header=True)    