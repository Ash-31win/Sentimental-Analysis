...
df_positive.to_csv (r'C:\Users\HP\Desktop\sentimental analysis\df_bow4_positive.csv', index = False, header=True)    
df_negative.to_csv (r'C:\Users\HP\Desktop\sentimental analysis\df_bow4_negative.csv', index = False, header=True)    